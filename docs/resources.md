...
- [kubernetes-ingress-guide-nginx](https://matthewpalmer.net/kubernetes-app-developer/articles/kubernetes-ingress-guide-nginx-example.html)
- https://matthewpalmer.net/kubernetes-app-developer/articles/kubernetes-networking-guide-beginners.html
### Rate Limiting with Kubernetes Ingress-Nginx
